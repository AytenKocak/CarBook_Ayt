...
{
    public class _BlogDetailCloudTagByBlogComppnentPartial: ViewComponent
    {

        private readonly IHttpClientFactory _httpClientFactory;

        public _BlogDetailCloudTagByBlogComppnentPartial(IHttpClientFactory httpClientFactory)
        {
